 ...
 * @since 1.0.0
 */
class Widget_Google_Maps_He extends Widget_Base {
	...
	public function get_title() {
		return __( 'Google Maps Hebrew', 'elementor' );
	}
	...
	protected function render() {
		...
		printf(
			'<div class="elementor-custom-embed"><iframe frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?q=%s&amp;t=m&amp;z=%d&amp;output=embed&amp;iwloc=near&amp;hl=he-IL" aria-label="%s"></iframe></div>',
