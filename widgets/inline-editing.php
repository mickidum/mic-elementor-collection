...
class Inline_Editing extends Widget_Base {
	...
	public function get_title() {
		return __( 'Inline Editing', 'mic-elementor-collection' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Title', 'mic-elementor-collection' ),
			]
		);
		...
		$this->add_control(
			'description',
			[
				'label' => __( 'Description', 'mic-elementor-collection' ),
				'type' => Controls_Manager::TEXTAREA,
				'default' => __( 'Description', 'mic-elementor-collection' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Content', 'mic-elementor-collection' ),
			]
		);
